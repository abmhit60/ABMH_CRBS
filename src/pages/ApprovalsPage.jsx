            ...
            {b.status === 'confirmed' && (
              rescheduling === b.id
                ? <div className="reject-form" style={{ marginTop: 12 }}>
                    <p style={{ fontSize: 13, fontWeight: 600 }}>Reschedule</p>
                ...
                : rejecting === b.id
                  ...
                  : <div className="bcard-actions" style={{ marginTop: 10 }}>
                      <button className="btn btn-outline btn-sm" onClick={() => { setRescheduling(b.id); setRf({ date: format(parseISO(b.start_time), 'yyyy-MM-dd'), start: format(parseISO(b.start_time), 'HH:mm'), end: format(parseISO(b.end_time), 'HH:mm') }) }}>📅 Reschedule</button>
